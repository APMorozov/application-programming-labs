...
# Form implementation generated from reading ui file 'GUIlab5.ui'
#
...
"color:rgb(28, 32, 113)")
        ...
        self.inpt_path = QtWidgets.QLabel(self.centralwidget)
...
"color:rgb(28, 32, 113)")
    ...
    def retranslateUi(self, MainWindow) -> None:
        ...
        self.inpt_path.setText(_translate("MainWindow", "Input"))
    ...
    def take_next(self, path) -> None:
        ...
        '''
        if self.counter == 0:
            logging.info(f"PATH to annotation:{path}")
            logging.info('Init iterator')
            try:
                self.iterator = ImgIterator(path)
                iter(self.iterator)
            except Exception as ex:
                logging.info("Init iterator error", ex)
            ...
            try:
                 ...
                 logging.info(F"Path to img:{imgPath[1]}")
                 self.label_img.setPixmap(QtGui.QPixmap(imgPath[1]))
                 self.counter += 1
            except StopIteration:
                logging.info("No more img")
                widget = QtWidgets.QDialog()
                wid = Ui_Form()
    ...
    def take_csvpath(self) -> None:
        ...
        if dialog.exec():
            ...
            self.annotationPath = path[0]
            self.inpt_path.setText(path[0])
            wid = Ui_Form()
